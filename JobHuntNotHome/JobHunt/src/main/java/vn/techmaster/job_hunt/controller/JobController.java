...
public class JobController {
  ...
  public String listAllJob(Model model) {
    ...
    model.addAttribute("applicantTotal",applicantRepo.countApplicantTotal());
    return "job_home";
  }
  ...
  @GetMapping("/search")
  public String searchJob(Model model, @ModelAttribute("searchRequest") SearchRequest searchRequest){
